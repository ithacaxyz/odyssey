...
pub static ODYSSEY_MAINNET: LazyLock<Arc<OpChainSpec>> = LazyLock::new(|| {
    OpChainSpec::new(ChainSpec {
        chain: Chain::from_named(NamedChain::Odyssey),
        // genesis contains an empty alloc field because the state at first bedrock block is imported
        // manually from a trusted source
    ...
    fn parse(s: &str) -> eyre::Result<Arc<Self::ChainSpec>> {
        Ok(match s {
            ...
            s => {
                ...
                // generator, we simply remove the root of the request manually here.
